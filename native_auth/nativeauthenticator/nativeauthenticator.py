...
from traitlets import Bool, Dict, Integer, Tuple, Unicode, Set
...
class NativeAuthenticator(Authenticator):
    ...
    use_allowed_users = Bool(
        config=True,
        default_value=False,
        help="Set of usernames that are allowed to access the system."
    )
